...
class PersonAccountingProxy(AccountingProxy):
    ...
    def pay_membership_fee(self, gas, year):
        ...
        exit_point = self.system['/expenses/gas/' + str(gas.uid) + '/fees']
    ...
    def do_recharge(self, gas, amount):
        ...
        source_account = self.system['/wallet']
        exit_point = self.system['/expenses/gas/' + str(gas.uid) + '/recharges']
        entry_point =  gas.system['/incomes/recharges']
        target_account = gas.system['/members/' + str(person.uid)]
...
class GasAccountingProxy(AccountingProxy):
    ...
    def pay_supplier(self, pact, amount, refs=None):
        ...
        exit_point = self.system['/expenses/suppliers/' + str(supplier.uid)]
        entry_point =  supplier.system['/incomes/gas' + str(gas.uid)]
    ...
    def withdraw_from_member_account(self, member, amount, refs=None):
        ...
        gas = self.subject.instance
        source_account = self.system['/members/' + str(member.uid)]
...
class SupplierAccountingProxy(AccountingProxy):
    ...
    def refund_gas(self, gas, amount, refs=None):
        ...
        source_account = self.system['/wallet']
        exit_point = self.system['/incomes/gas/' + str(gas.uid)]
        entry_point = gas.system['/expenses/suppliers/' + str(supplier.uid)] 
        target_account = gas.system['/cash']
...
class Person(models.Model):
    ...
    def uid(self):
        """
        A unique (database independent) ID for ``Person`` model instances.
        """
...
class GAS(models.Model):
    ...
    def uid(self):
        """
        A unique (database independent) ID for ``GAS`` model instances.
        """
        # in a real word scenario, UIDs should be generated by a more robust algorithm
        return self.name
...
class GASMember(models.Model):
    ...
    def uid(self):
        """
        A unique (database independent) ID for ``GASMember`` model instances.
        """
...
class Supplier(models.Model):
    ...
    def uid(self):
        """
        A unique (database independent) ID for ``Supplier`` model instances.
        """
        # in a real word scenario, UIDs should be generated by a more robust algorithm
        return self.name
